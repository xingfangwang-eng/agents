-- Final solution for embedding vectors
-- This script uses array_fill to create 768-dimensional vectors
-- Run this in Supabase SQL Editor

-- Step 1: Update all tools with a 768-dimensional zero vector
-- Using array_fill with float values
update tools
...
select * from search_tools(
  vector(array_fill(0.0::float, array[768])),
  0.1,
  5
);