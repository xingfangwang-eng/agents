...
insert into tools (slug, name, description, category, tags, pricing, features, prompt_templates, is_featured)
values
('sales-assistant-pro', 'Sales Assistant Pro', 'AI-powered sales assistant for lead generation, follow-ups, and closing deals.', 'Sales & Support', '{sales, lead generation, follow-up, closing}', 'Paid', '{"Lead Qualification": "Identify qualified leads", "Follow-up Sequences": "Automate follow-up emails", "Closing Strategies": "Develop closing techniques"}', '{"Cold Email": "Write a cold email to [prospect] offering [product/service].", "Follow-up Email": "Create a follow-up email for a prospect who hasn\'t responded."}', true),
...
insert into tools (slug, name, description, category, tags, pricing, features, prompt_templates, is_featured)
values
('business-framework-ai', 'Business Framework AI', 'Apply proven business frameworks to solve business challenges.', 'Frameworks', '{business, frameworks, strategy}', 'Paid', '{"Framework Application": "Apply business frameworks", "Problem Solving": "Solve business problems", "Strategy Development": "Create business strategies"}', '{"SWOT Analysis": "Apply SWOT analysis to [business situation].", "Porter\'s Five Forces": "Analyze [industry] using Porter\'s Five Forces framework."}', true),
...
-- Step 8: Create function to generate embeddings using Gemini API
...
-- Step 9: Update embeddings for all tools
UPDATE tools
